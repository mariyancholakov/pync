...
graph LR
    ...
    style Swarm fill:#00BCD4,stroke:#00838F,color:white
    style Relay fill:#FF9800,stroke:#F57C00,color:white
    style Peers fill:#4CAF50,stroke:#388E3C,color:white
    style Sidecar fill:#607D8B,stroke:#455A64,color:white
```
